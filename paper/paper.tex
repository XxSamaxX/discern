...
the gap's AUC falls to 0.777 and the probability is $\geq 0.99$ on 86\% of the
errors: the signal weakens as the option set shrinks, and a threshold tuned on
four-way questions does not transfer to two-way ones.
...
answers at AUC 0.777, against 0.894 on MMBench, and the reported probability is
$\geq 0.99$ on 86\% of the errors rather than 52\%. The median gap when the
model is wrong rises from 5.2 nats on MMBench to 16.4 here: with two slots the
